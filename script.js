...
function importarPlanilhaGitHub() {
    const url = "https://raw.githubusercontent.com/ELIEDSON-GUSTAVO/GERADOR_DE_PLANILHA_KAMBAM/9bd2c755e9fb68199cad38e55824759ebaa5dfbd/DADOS.xlsx";
...
function gerarCSV() {
    ...
    link.download = "itens_e_pecas.csv";
    link.click();
}
...
window.onload = function() {
    importarPlanilhaGitHub(); // Chama a função para importar a planilha
};
